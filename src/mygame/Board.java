...
//    public void setPlayerPiece(LinkedList<Spatial> piece, int num)
//    {
//        for (int i = 0; i < piece.size(); i++)
//        {
//            if (piece.get(i).getName().equals("pawn") && num == 1)
//            {
//                for (int p = 0; p < 8; p++)
//                {
//                    board[1][p] = "p1";
...
//            }
//            
//            if (piece.get(i).getName().equals("rook") && num == 1)
//            {
//                board[0][0] = "r1";
//                board[0][7] = "r1";
//            }
...
//            }
//            
//            if (piece.get(i).getName().equals("knight") && num == 1)
//            {
//                board[0][1] = "k1";
//                board[0][6] = "k1";
//            }
...
//            }
//            
//            if (piece.get(i).getName().equals("bishop") && num == 1)
//            {
//                board[0][2] = "b1";
//                board[0][5] = "b1";
//            }
...
//            }
//            
//            if (piece.get(i).getName().equals("queen") && num == 1)
//            {
//                board[0][3] = "q1";
//            }
//            else
...
//            }
//            
//            if (piece.get(i).getName().equals("king") && num == 1)
//            {
//                board[0][4] = "K1";
//            }
//            else
